 ...
 * Charset Handling
 *
 * Charset extraction from Content-Type headers and buffer decoding,
 * including a Windows-1251 (Cyrillic) decoder for Russian/Ukrainian/
 * Bulgarian websites that still serve that encoding.
 *
 * @module proxy/charset
 */
